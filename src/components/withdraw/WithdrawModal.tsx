        ...
        <div>
          ...
          {withdrawEle.pool? (
              <>
                ...
                />
              <span>{withdrawEle.amountToken1?withdrawEle.amountToken1:withdrawEle.pool.token1.name}</span>
              </>
            ) : (
            ...
            {withdrawEle.pool?  (
              <>
                <img
                  ...
                  className="w-6 h-6 mr-2"
                />
              <span>{withdrawEle.amountToken2?withdrawEle.amountToken2:withdrawEle.pool.token2.name}</span>
              </>
            ) : (
              <span>Select a pool to display token</span>
            )}
